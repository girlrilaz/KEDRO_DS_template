...
# kedro_iris_package documentation build
...
from kedro_iris_package import __version__ as release

# -- Project information -----------------------------------------------------

project = "kedro_iris_package"
copyright = "2020, QuantumBlack Visual Analytics Limited"
author = "QuantumBlack"
...
htmlhelp_basename = "kedro_iris_packagedoc"
...
latex_documents = [
    (
        master_doc,
        "kedro_iris_package.tex",
        "kedro_iris_package Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kedro_iris_package",
        "Project kedro_iris_package codebase.",
        "Data-Science",
    )
]
